    ...
    public function render_shortcode() {
        ...
        <div class="speedx-game-wrapper" data-game-root>
            ...
            <div class="speedx-start-screen" data-start-screen>
                ...
                <input
                    id="speedx-passphrase"
                    class="speedx-input"
                    type="text"
                    autocomplete="off"
                    spellcheck="false"
                    placeholder="<?php echo esc_attr__('Type dr driving to start', 'speedx-car-game'); ?>"
                    data-passphrase-input
                />
                <button class="speedx-start-btn" type="button" data-start-button disabled>
                    <?php echo esc_html__('Start Game', 'speedx-car-game'); ?>
                </button>
            ...
            <div class="speedx-game-over is-hidden" data-game-over>
                ...
                <button class="speedx-restart-btn" type="button" data-restart-button>
                    <?php echo esc_html__('Restart', 'speedx-car-game'); ?>
                </button>
            </div>
        </div>
        <?php
